...
//		System.out.println(i1 > i3); -> ordinal로 비교 : 0-2 = -2
		...
		//열거형을 안쓸 때
		int color = 999999999; //문법적으로는 틀린 건 아니라서 에러는 안남
		//단 우리가 설정한 색의 범주가 아님 (RED,GREEN,BLUE)
